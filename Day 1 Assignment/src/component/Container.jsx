...
function Container() {
  return (
    <>
    {/* <div className='min-h-full bg-pink-900 w-[1000px] flex justify-evenly items-center'> */}
    <div className='w-full h-[450px] bg-pink-400 flex justify-between'>
      <div className='min-h-full bg-green-900 w-[620px] flex justify-evenly items-center'>
    <img className= 'w-full h-full' src="./Images/img1.jpg" alt="" />
